...
impl FrontendFramework {
    pub fn dev_command(&self) -> String {
        match self {
            ...
            FrontendFramework::Angular => "ng serve".to_string(),
...
pub enum FrontendLogEvent {
    ...
    CompileStart,
    CompileSuccess { duration: f64 },
    CompileError { message: String },
    HotModuleReplacement { file: String },
    ApiRequest { method: String, path: String, status: Option<u16> },
